<form action="{{route('promo-code.store')}}" method="POST" enctype="multipart/form-data" class="offcanvas offcanvas-end offcanvas-01" data-bs-backdrop="static" id="offcanvasPromoAdd" tabindex="-1" aria-labelledby="offcanvasPromoAddLabel">
