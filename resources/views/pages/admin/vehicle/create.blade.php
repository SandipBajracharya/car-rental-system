<form action="{{route('vehicle.store')}}" method="POST" enctype="multipart/form-data" class="offcanvas offcanvas-end offcanvas-01" data-bs-backdrop="static" id="offcanvasVehicleAdd" tabindex="-1" aria-labelledby="offcanvasVehicleAddLabel">
