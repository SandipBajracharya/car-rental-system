...
<body>
    <form action="{{route('user.store-addn-info')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="date" name="from_dt" class="form-control"/>
        </div>
        <div class="form-group">
            <label for="">To date</label>
            <input type="date" name="to_dt" class="form-control"/>
        </div>
        <input type="_hidden" name="vehicle_id" value="1" class="form-control"/>
